    ...
    <>
      ...
      <main className="w-full bt-16 flex flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          <AnimatedText
            text="Welcome to My Projects Gallery!"
          ...
          <div className="grid grid-col-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            ...
            <div className="col-span-12">
              {" "}
              <FeaturedProject
                title="Advanced Online Learning Platform"
                summary="EduCoursePro is a cutting-edge online learning platform designed for seamless course management and student engagement, inspired by leading educational platforms like Scalar Academy. This web-based application empowers students to explore, enroll in, and manage their courses effortlessly. With robust security measures, including JWT token-based authentication, EduCoursePro ensures safe and secure access to personalized features like updating profile information and managing address details. The platform also supports efficient image uploads via multipart files, enhancing the overall user experience. Leveraging the power of Spring Boot (J2EE), React.js, and MySQL, EduCoursePro offers a dynamic and interactive environment for pursuing educational goals."
                link="https://github.com/Prashantkhamitkar/NovialEducation.git"
                github="https://github.com/Prashantkhamitkar/NovialEducation.git"
                type="Featured Project"
                img={Studproject1}
              />
            </div>
